  ...
  public: {
    Tables: {
      ...
      launch_dependencies: {
        ...
        Relationships: [
          {
            foreignKeyName: "launch_dependencies_source_step_id_fkey"
            columns: ["source_step_id"]
            isOneToOne: false
            referencedRelation: "launch_steps"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "launch_dependencies_target_step_id_fkey"
      ...
      launch_steps: {
        ...
        Relationships: [
          {
            foreignKeyName: "launch_steps_assignee_id_fkey"
            columns: ["assignee_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "launch_steps_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
